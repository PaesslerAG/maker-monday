...
struct PmResult: public Result {
  ...
  PmResult(const Status &status, byte *bytes): Result(status, bytes) {
    ...
    switch (status) {
      case Status::Ok: rawStatus = 0; break;
      case Status::NotAvailable: rawStatus=1;break;
      case Status::InvalidChecksum: rawStatus=2;break;
      case Status::InvalidResponseId: rawStatus=3;break;
      case Status::InvalidHead: rawStatus=4;break;
      case Status::InvalidTail: rawStatus=5;break;
      default: rawStatus = 255;break;
    }
