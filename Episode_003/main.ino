...
const char* DNSNAME = "wakeup";


/**************************** FOR OTA **************************************************/
#define SENSORNAME "ledstrip"   //change this to whatever you want to call your device
#define OTApassword "Master"    //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;



/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "ledstrip/wakeup";      // Set your MQTT topics
const char* light_set_topic = "ledstrip/wakeup/set";    // Set your MQTT topics
...
/*********************************** FastLED Defintions ********************************/
#define NUM_LEDS    16      // Set Number of LED here
#define DATA_PIN    14      // Set Data here
//#define CLOCK_PIN 5
#define CHIPSET     WS2812B // Set LED type here
#define COLOR_ORDER GRB     // Set color order if colores are incorrect
